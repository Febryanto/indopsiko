...
<html lang="en" >
    ...
    <head>
        ...
        <title>Indopsiko | Dashboard</title>
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed " >
	<div class="kt-header-mobile__brand">
		<a class="kt-header-mobile__logo" href="/metronic/preview/demo5/index.html">
...
<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside" style="background-color:whitesmoke;">
	...
	<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
		<div id="kt_aside_menu"
            ...
            <li class="kt-menu__item " aria-haspopup="true" >
                <a href="/metronic/preview/demo5/#.html" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-database"></i>
                    <span class="kt-menu__link-text">Profil</span></a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true" >
                <a  href="/metronic/preview/demo5/#.html" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-cube"></i>
                    <span class="kt-menu__link-text">Klient</span>
                </a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true" >
                <a  href="/metronic/preview/demo5/#.html" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-newspaper"></i>
                    <span class="kt-menu__link-text">Berita</span>
                </a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true" >
                <a  href="/metronic/preview/demo5/#.html" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-bullhorn"></i>
                    <span class="kt-menu__link-text">Pengumuman</span>
                </a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true" >
                <a  href="/metronic/preview/demo5/#.html" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-briefcase"></i>
                    <span class="kt-menu__link-text">Lowongan</span>
                </a>
            </li>
            <li class="kt-menu__item " aria-haspopup="true" >
                <a  href="/metronic/preview/demo5/#.html" class="kt-menu__link "><i class="kt-menu__link-icon fa fa-users"></i>

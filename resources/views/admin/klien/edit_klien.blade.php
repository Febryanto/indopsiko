    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
        ...
        <div class="kt-portlet">
            ...
            <div class="kt-form kt-form--label-right">
                <div class="kt-portlet">
                    @foreach ($data as $u)
                    <form method="post" action="{{ route('klien.update',$u->id_klien) }}"  enctype="multipart/form-data">
                      {{ csrf_field() }}
                      {{ method_field('PUT') }}
                      <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-6">
                                <img class="kt-avatar__holder" src="/assets/images/klien/{{$u->logo}}" id="showgambar" style="height:300px;" alt="">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-10">
                              <textarea name="deskripsi"  cols="100" rows="10">{{$u->deskripsi}}</textarea>
                          </div>
                        </div>
                        <div class="form-group">

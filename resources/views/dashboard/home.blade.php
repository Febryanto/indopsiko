    ...
    <div class="container-fluid">
      <div class="row text-center">
        ...
        <div class="row">
          <div class="column pk">
            <div class="content">
              <img src="/assets/images/galeri/pegawai.jpg" alt="pegawai" style="width:100%">
            </div>
          </div>
		  <div class="column pk">
            <div class="content">
          ...
          <div class="column pk">
            <div class="content">
              <img src="/assets/images/galeri/pegawai3.jpeg" alt="pegawai" style="width:100%">
            </div>
	        </div>
          ...
          <div class="column training">
            <div class="content">
              <img src="/assets/images/galeri/training3.jpg" alt="training" style="width:100%">
            </div>
          </div>
        {{-- <!-- END GRID --> --}}
        </div>
